      ...
      <div class="modal-body">
        ...
        <?php
			// membuat kode urut otomatis sebagai id lapangan
						...
						$nextID = "CN".sprintf("%03s",$nextNoUrut);
						?>
          <div class="form-group">
            <label class="control-label col-sm-4" for="email">Kode Toko</label>
            <div class="col-sm-8">
          ...
          <div class="form-group">
            <label class="control-label col-sm-4" for="email">Jenis Toko</label>
            <div class="col-sm-8">
              <select class="form-control" name="jenis_rumput"  required>
                <option disabled="disabled">--- Pilih Jenis Usaha ---</option>
          ...
          <div class="form-group">
            <label class="control-label col-sm-4" for="email">Nomor Pemilik</label>
            <div class="col-sm-8">
              <input type="text" class="form-control" id="pwd" name="no_lap" placeholder="Nomor HP">
            </div>
          </div>
          <div class="form-group">
            <label class="control-label col-sm-4" for="email">Harga</label>
            <div class="col-sm-8">
               <input type="text" class="form-control" name="harga" id="pwd" placeholder="Kisaran Harga di Menu">
            </div>
          </div>
          <div class="form-group">
