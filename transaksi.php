...
<head>
    ...
    <title>Cangs.Sub || Pemesanan</title>
    <!-- Custom Theme Style -->
    ...
    include "opt_login.php";
     ?>
        ...
        <div class="panel panel-default">
          ...
          <h4>Booking Tempat Cangs Anda dan Segera Lakukan Pembayaran untuk DP </h4>
          <hr>
		  ...
		  // membuat kode urut otomatis sebagai ID booking
                        ...
                        <form class="form-horizontal form-label-left" method="post">
                          ...
                          <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Nama <?php echo $pilih['jenis_rumput']; ?><span class="required"></span>
                            </label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                          ...
                          <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Tanggal Cangs<span class="required"></span>
                            </label>
                            ...
                            <div class="col-md-1 col-sm-1 col-xs-2">
                              <label class="control-label" for="last-name">Jam<span class="required"></span>
                            </label>
                            </div>
                            <div class="col-md-2 col-sm-2 col-xs-4">
                              <select class="form-control form-control col-md-4 col-xs-6" name="jam_mulai" id="sel1">
                                ...
                                <option>23:00</option>
                                  ...
                                  <div class="form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Durasi Cangs<span class="required"></span>
                                    </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                         ...
                         <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Jumlah DP<span class="required"></span>
                            </label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                              <input type="text" name="total_harga" required="required" class="form-control col-md-7 col-xs-12" value="0">
                            </div>
                          </div>
