     ...
     <div id="myCarousel" class="carousel slide" data-ride="carousel">
         ...
         <div class="carousel-inner" role="listbox">
           <div class="item active">
             <img src="assets/sub/1.jpg" alt="Image" width="100%" height="10">
           ...
           <div class="item">
             <img src="assets/sub/2.jpg" alt="Image" width="100%" height="10px">
             <div class="carousel-caption">
         ...
         <div class="item">
             <img src="assets/sub/3.jpg" alt="Image" width="100%" height="10px">
             <div class="carousel-caption">
         ...
         <div class="item">
             <img src="assets/sub/4.jpg" alt="Image" width="100%" height="10px">
             <div class="carousel-caption">
         ...
         <div class="item">
             <img src="assets/sub/5.jpg" alt="Image" width="100%" height="10px">
             <div class="carousel-caption">
           ...
           <div class="item">
             <img src="assets/sub/6.jpg" alt="Image" width="100%" height="10px">
             <div class="carousel-caption">
           ...
           <div class="item">
             <img src="assets/sub/7.jpg" alt="Image" width="100%" height="10px">
             <div class="carousel-caption">
    ...
    <div class="w3-container w3-card-2 w3-white w3-round" style="margin-left: 10px; margin-top:10px;"><br>
              ...
              <div class="w3-row-padding" style="margin:0 -16px">
                ...
                <div class="w3-half">
                  ...
                  <i class="fa fa-list-alt" aria-hidden="true"></i> Nomor Pemilik&nbsp;<?php echo $r['no_lap']; ?><br><br>
                  <i class="fa fa-life-ring" aria-hidden="true"></i> Jenis <?php echo $r['jenis_rumput']; ?><br><br>
                  <i class="fa fa-tags" aria-hidden="true"></i>Kisaran Rp. <?php echo $r['harga']; ?><br><br><br><br>
