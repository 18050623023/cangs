...
<html lang="en">
  ...
  <link rel="shortcut icon" href="../assets/images/Goputsalgaji.png">
    ...
    <title>Cangs.Sub || Administration </title>
        ...
        <div class="col-md-3 left_col menu_fixed">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="index.php" class="site_title"><img src="../assets/images/Goputsalgaji.png" style="width:30px; height:30px;"> <span>Cangs.Sub</span></a>
            </div>
                ...
                <ul class="nav side-menu">
                  <li><a><i class="fa fa-th-list"></i> Data Anggota <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      ...
                      <li><a href="index.php?url=lap">Tempat Cangs</a></li>
                    </ul>
                  </li>
